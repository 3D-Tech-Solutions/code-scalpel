...
class TestRustNormalizer:
    ...
    def test_if_expression(self):
        from code_scalpel.ir.nodes import IRExprStmt, IRFunctionDef, IRIf
    ...
    def test_macro_invocation(self):
        from code_scalpel.ir.nodes import IRCall, IRExprStmt, IRFunctionDef
